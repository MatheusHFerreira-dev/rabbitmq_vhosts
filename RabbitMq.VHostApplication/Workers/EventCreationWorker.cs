...
public class EventCreationWorker
{
    private const string InputQueue = "event_creation_queue";
    private const string OutputQueue = "event_processing_queue";
